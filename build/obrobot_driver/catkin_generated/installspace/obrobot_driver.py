...
class BaseController:
    def __init__(self, Stm32, base_frame):
        ...
        #rospy.Subscriber("car_changeposition", Point, self.car_changeposition) #jinliang_3.7 
        #self.car_changeok = rospy.Publisher("car_changeok", Point, queue_size=5) #jinliang 3.7
        ...
        # rospy.Subscriber("set_arm_relay", Int16, self.set_arm_relay) #obrobot_arm
    ...
    # def singlemotorCallback(self, req): #obrobot_arm
    #     a = req.x #ID
    #     b = req.y #time
    #     c = req.z * 100 #angular
    #     rospy.loginfo("............setting single motor angular..............")
    #     rospy.loginfo("motor ID= %f",a)  
    #     rospy.loginfo("action tme= %f",b)
    #     rospy.loginfo("motor angular= %f",c)
    #     self.Stm32.single_motor_drive(a, b, c)
    ...
    def poll(self):
        ...
        if True:
            ...
            # zark 20190709
            # temp=5
            # if self.v_des_left<0 and self.v_des_left>-temp:
            #     self.v_des_left=-temp
            # elif self.v_des_left>0 and self.v_des_left<temp:
            #     self.v_des_left=temp
            # if self.v_des_right<0 and self.v_des_right>-temp:
            #     self.v_des_right=-temp
            # elif self.v_des_right>0 and self.v_des_right<temp:
            #     self.v_des_right=temp                            

            # if (self.v_left>0 and self.v_des_left<0) or (self.v_left<0 and self.v_des_left>0):
            #     temp = 0.05
            # else:
            #     temp = 0.3
            ...
            #     temp=0.5
            # else:
            #     temp=abs((self.v_des_left - self.v_left)/self.v_left)*0.5
            #     if temp>1.0:
            #         temp=1.0
            ...
            # if (self.v_right>0 and self.v_des_right<0) or (self.v_right<0 and self.v_des_right>0):
            #     temp = 0.05
            # else:
            # #     temp = 0.3
            # if self.v_right==0:
            #     temp=0.5
            # else:
            #     temp=abs((self.v_des_right - self.v_right)/self.v_right)*0.5
            #     if temp>1.0:
            #         temp=1.0
            #temp=0.3
            temp=0.4 #0.3
            ...
            # temp=5
            # if self.v_left<0 and self.v_left>-temp:
            #     self.v_left=-temp
            # elif self.v_left>0 and self.v_left<temp:
            #     self.v_left=temp
            # if self.v_right<0 and self.v_right>-temp:
            #     self.v_right=-temp
            # elif self.v_right>0 and self.v_right<temp:
            #     self.v_right=temp 
    ...
    def cmdVelCallback(self, req):
        ...
        # temp=0.3 #0.3#
        # x = (req.linear.x  - self.x_last) * temp + self.x_last
        # if abs(x - req.linear.x) < 0.05:
        #     x = req.linear.x

        # if abs(x)<0.2:
        #     temp=0.1 #0.3#
        #     th = (req.angular.z  - self.th_last) * temp + self.th_last
        #     if abs(th - req.angular.z) < 0.05:
        #         th = req.angular.z
        ...
        # if x == 0:
            ...
            #     if th>0.0 and th<self.start_rotation_limit_w_x0:
            #         th=self.start_rotation_limit_w_x0
            #         rospy.loginfo("x==0 th = +") 
            #     elif th>-self.start_rotation_limit_w_x0 and th<0.0:
            #         th=-self.start_rotation_limit_w_x0
            #         rospy.loginfo("x==0 th = -")
        #     #print "1111gaibianhou w= "+str(th)start_rotation_limit_w_x0
        # elif th == 0:
        ...
        #         rospy.loginfo("x<-0.1 th = +")
        #     if (th<0.0 and th >-self.start_rotation_limit_w) and (x>-0.1 and x<0):
        #         th=-self.start_rotation_limit_w
        #         rospy.loginfo("x>0.1 th = -")

        #     # if (th>0.0 and th<self.start_rotation_limit_w) and x<0:
        #     #     th=self.start_rotation_limit_w
        #     # if (th<0.0 and th >-self.start_rotation_limit_w) and x<0:start_rotation_limit_w_x0
        #     #     th=-self.start_rotation_limit_w

        #     # if th>0.0 and th<self.start_rotation_limit_w:
        #     #     th=self.start_rotation_limit_w
        #     # elif th>-self.start_rotation_limit_w and th<0.0:
        #     #     th=-self.start_rotation_limit_w
        ...
        # self.v_des_left = (left * self.ticks_per_meter) #zark 20190709
        # self.v_des_right = (right * self.ticks_per_meter)           
        # self.v_des_left = (left * self.ticks_per_meter) #zark 20190709
        # self.v_des_right = (right * self.ticks_per_meter)           
        # rospy.loginfo("aaa")
        # self.v_des_left = (left * self.ticks_per_meter) #zark 20190709
        # self.v_des_right = (right * self.ticks_per_meter)           
        # self.v_des_left = (30*left * self.ticks_per_meter / self.Stm32.PID_RATE) #zark 20190709
        # self.v_des_right = (30*right * self.ticks_per_meter / self.Stm32.PID_RATE)  
         
        #self.v_des_left = (1.25*left * self.ticks_per_meter / self.Stm32.PID_RATE) #yimu
        #self.v_des_right = (1.25*right * self.ticks_per_meter / self.Stm32.PID_RATE) 
          

        # print(self.v_des_left , self.v_des_right)
