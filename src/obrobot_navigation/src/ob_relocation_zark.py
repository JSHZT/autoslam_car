...
class Relocation():
    def __init__(self):
        ...
        self.deltaangle = 360.0 / 800 / 180 * math.pi
        ...
        self.relocation_finish_pub = rospy.Publisher("/ob_relocation_finish", Bool, queue_size = 5)
    ...
    def relocationcallback(self, data):
        ...
        if(maxscore < 0.3 * len_laser_obs):
            ...
            self.relocation_finish_pub.publish(True)
    ...
    def getlaserdata(self, laserdata):
        ...
        if self.getlaserflag is False:
            ...
            if(self.getlasercnt > 15):
                ...
                for tempi in range(0, len(laserdata.ranges)):
