...
class TOD(object):
    ...
    def __init__(self):
        ...
        self.auto_slam_finish_cnt_threshold = 5
    ...
    def mainloop(self):
        ...
        while(self.img_Res == 0):
            rospy.sleep(0.5)
            rospy.loginfo("waiting for map")
        cannot_reach_value = 100000
        if self.finish_flag is True:
            runtimenow = rospy.get_time()
            if(runtimenow - self.lastruntime < 4) and self.auto_slam_finish_cnt == 0:
    ...
    ###############
            ...
            if self.auto_slam_finish is True:
                ...
                subprocess.call('rosrun map_server map_saver -f /home/ob/.ob/document/map/ob_autoslam', shell=True)
                subprocess.call('rosrun map_server map_saver -f /home/ob/map/ydlidar_gmapping_HomeOnBright', shell=True)
