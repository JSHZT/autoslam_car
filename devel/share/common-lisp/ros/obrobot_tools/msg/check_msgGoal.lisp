...
(cl:in-package obrobot_tools-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <check_msgGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'check_msgGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obrobot_tools-msg:<check_msgGoal> is deprecated: use obrobot_tools-msg:check_msgGoal instead.")))

(cl:ensure-generic-function 'imu-val :lambda-list '(m))
(cl:defmethod imu-val ((m <check_msgGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obrobot_tools-msg:imu-val is deprecated.  Use obrobot_tools-msg:imu instead.")
  (imu m))

(cl:ensure-generic-function 'method-val :lambda-list '(m))
(cl:defmethod method-val ((m <check_msgGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obrobot_tools-msg:method-val is deprecated.  Use obrobot_tools-msg:method instead.")
  (method m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <check_msgGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obrobot_tools-msg:distance-val is deprecated.  Use obrobot_tools-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'angule-val :lambda-list '(m))
(cl:defmethod angule-val ((m <check_msgGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obrobot_tools-msg:angule-val is deprecated.  Use obrobot_tools-msg:angule instead.")
  (angule m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <check_msgGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obrobot_tools-msg:vel-val is deprecated.  Use obrobot_tools-msg:vel instead.")
  (vel m))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <check_msgGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obrobot_tools-msg:error-val is deprecated.  Use obrobot_tools-msg:error instead.")
  (error m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<check_msgGoal>)))
  ...
  "49ffb1d067a2ea13f4a3e8f7374f2450")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'check_msgGoal)))
  "Returns md5sum for a message object of type 'check_msgGoal"
  "49ffb1d067a2ea13f4a3e8f7374f2450")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<check_msgGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal definition~%string imu~%string method~%float32 distance~%float32 angule~%float32 vel~%float32 error~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'check_msgGoal)))
  "Returns full string definition for message of type 'check_msgGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal definition~%string imu~%string method~%float32 distance~%float32 angule~%float32 vel~%float32 error~%~%~%"))
