...
(cl:in-package obrobot_driver-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvInt32-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvInt32-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obrobot_driver-srv:<SrvInt32-request> is deprecated: use obrobot_driver-srv:SrvInt32-request instead.")))

(cl:ensure-generic-function 'arg1-val :lambda-list '(m))
(cl:defmethod arg1-val ((m <SrvInt32-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obrobot_driver-srv:arg1-val is deprecated.  Use obrobot_driver-srv:arg1 instead.")
  (arg1 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvInt32-request>)))
  ...
  "obrobot_driver/SrvInt32Request")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvInt32-request)))
  "Returns string type for a service object of type 'SrvInt32-request"
  "obrobot_driver/SrvInt32Request")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvInt32-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvInt32-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obrobot_driver-srv:<SrvInt32-response> is deprecated: use obrobot_driver-srv:SrvInt32-response instead.")))

(cl:ensure-generic-function 'val-val :lambda-list '(m))
(cl:defmethod val-val ((m <SrvInt32-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obrobot_driver-srv:val-val is deprecated.  Use obrobot_driver-srv:val instead.")
  (val m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvInt32-response>)))
  ...
  "obrobot_driver/SrvInt32Response")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvInt32-response)))
  "Returns string type for a service object of type 'SrvInt32-response"
  "obrobot_driver/SrvInt32Response")
