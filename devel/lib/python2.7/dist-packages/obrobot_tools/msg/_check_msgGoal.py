...
"""autogenerated by genpy from obrobot_tools/check_msgGoal.msg. Do not edit."""
import sys
...
class check_msgGoal(genpy.Message):
  _md5sum = "49ffb1d067a2ea13f4a3e8f7374f2450"
  _type = "obrobot_tools/check_msgGoal"
...
float32 error
"""
  __slots__ = ['imu','method','distance','angule','vel','error']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       imu,method,distance,angule,vel,error
